...
> [!CAUTION]
> ESM stores both raw data and code. Views are generated by executing code that is described in the ESM file (under the sections transformations and views). This means calling `esm views` involves executing arbitrary code. Only generate views from files you have verified are safe or come from a trusted source.
