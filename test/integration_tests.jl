...
@testitem "Summarise integration" setup=[environment_path, build, getshell] begin
    ...
    run(`$(shell) esm summarise $(joinpath(dir, "small.fcs")) --plot`)
    @test isfile(joinpath(dir, "small.fcs.pdf"))
    ...
    run(`$(shell) esm summarise $(joinpath(dir, "spectramax-summarise.txt")) -t spectramax --plot`)
    @test isfile(joinpath(dir, "spectramax-summarise.txt.pdf"))
    ...
    run(`$(shell) esm summarise $(joinpath(dir, "biotek-summarise.csv")) -t biotek -p`)
    @test isfile(joinpath(dir, "biotek-summarise.csv.pdf"))
    ...
    run(`$(shell) esm summarise $(joinpath(dir, "tecan-summarise.xlsx")) -t tecan -p`)
    @test isfile(joinpath(dir, "tecan-summarise.xlsx.pdf"))
    ...
    run(`$(shell) esm summarise $(joinpath(dir, "pr_folder")) -p`)
    @test isfile(joinpath(dir, "pr_folder.pdf"))
end
